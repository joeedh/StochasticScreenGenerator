...
define([
  ...
  var Class = util.Class, set = util.set;
  ...
  var bounded_acos = exports.bounded_acos = function bounded_acos(fac) {
    if (fac<=-1.0)
      return Math.pi;
    else 
      if (fac>=1.0)
  ...
  var saasin = exports.saasin = function saasin(fac) {
    if (fac<=-1.0)
      return -Math.pi/2.0;
    else 
      if (fac>=1.0)
  ...
  Matrix4.prototype = util.init_prototype(Matrix4, {
    clone : function() {
    ...
    fromJSON : util.static_method(function(json) {
      var mat=new Matrix4();
      mat.load(json.items);
    ...
    euler_rotate : function(x, y, z, order) {
      if (order == undefined) 
        order = "xyz"
      else
  ...
  var BaseVector = exports.BaseVector = Class(Array, [
    ...
    Class.static(function inherit(cls, vectorsize) {
  ...
  var Vector4 = exports.Vector4 = util.Class(BaseVector, [
  ...
  var Vector3 = exports.Vector3 = util.Class(BaseVector, [
    function constructor(data) {
      BaseVector.call(this);
    ...
    //normalizedDot4
    Class.static(function normalizedDot4(v1, v2, v3, v4) {
  ...
  var Vector2 = exports.Vector2 = Class(BaseVector, [
    function constructor(data) {
      BaseVector.call(this);
